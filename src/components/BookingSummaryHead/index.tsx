...
interface IBookingSummaryHead {
  isShow?: boolean;
  totalPrice: number;
  currency?: string;
}
const BookingSummaryHead: React.FC<IBookingSummaryHead> = ({
  isShow = true,
  totalPrice = 0,
  currency = "VND",
}) => {
        ...
        <div className="summary-inner flex items-center w-60 text-left">
          <div className="summary-cart-detail">
            ...
            <span className="text-xl font-bold text-emerald-500">
              <span className="amount">{moneyFormatNoSymbol(totalPrice)}</span>
              <span className="currency text-xs ml-1">{currency}</span>
            </span>
...
export default memo(BookingSummaryHead);
